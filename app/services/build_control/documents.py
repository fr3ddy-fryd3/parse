...
def get_project_documents(
    ...
    """
    url = (
        f"https://exv.portal.alabuga.ru/api/sk-service/v2/documents?"
    ...
    headers = {
        ...
        "Referer": f"https://exv.portal.alabuga.ru/projects/{project_id}/buildControl/documents/act-registry",
    }
